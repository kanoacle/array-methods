...
var nameArray = [];
nameArray.push('Kanoa', 'Cleveland');
...
var customOrder1 = [{takeOut: 'Pizza'}];
var customOrder2 = [{takeOut: 'Hot Dog'}];
var updatedOrders = orderQueue.concat(customOrder1, customOrder2);
